        ...
        <div className="md:col-span-2">
          ...
          <Tabs defaultValue="about" className="mt-8">
            ...
            <TabsContent value="about" className="p-4">
              <h3 className="text-lg font-semibold mb-2">About Dr. Sarah Johnson</h3>
              <p className="text-muted-foreground mb-4">
                Dr. Sarah Johnson is a board-certified cardiologist with over 10 years of experience in treating various
                heart conditions. She specializes in preventive cardiology, heart failure management, and cardiac
                rehabilitation.
              </p>
              <p className="text-muted-foreground">
                Dr. Johnson completed her medical degree at Harvard Medical School, followed by a residency at
                Massachusetts General Hospital and a fellowship in cardiology at Johns Hopkins Hospital.
              </p>
            </TabsContent>
            <TabsContent value="experience" className="p-4">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">New York Heart Center • 2018 - Present</p>
                </div>
                <div>
                  <h4 className="font-medium">Senior Cardiologist</h4>
                  <p className="text-sm text-muted-foreground">Memorial Hospital • 2015 - 2018</p>
                </div>
                <div>
                  <h4 className="font-medium">Cardiology Fellow</h4>
                  <p className="text-sm text-muted-foreground">Johns Hopkins Hospital • 2012 - 2015</p>
                </div>
              </div>
            </TabsContent>
                  ...
                  .map((_, i) => (
                    <div key={i} className="border-b pb-4 last:border-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          <p className="font-medium">{["John Doe", "Mary Kim", "Robert Lee"][i]}</p>
                          <div className="flex">
                            {Array(5)
                              .fill(0)
                              .map((_, j) => (
